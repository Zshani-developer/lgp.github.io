    ...
    <body>
                                    ...
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-3 col-xs-12">
                                                <label>&nbsp;</label>
                                                <button id="print_worth_report" type="button" class="btn btn-primary btn-block"> <i class="glyphicon glyphicon-print"></i></button>
        ...
        <script>
            $(document).ready(function() {
                $("#print_worth_report").click(function() {
                    let branchId = $("#select_branch").val();

                    if(branchId !== '') {
                        var win = window.open("print_worth_report?branch_id=" + branchId, "_blank");
                        if(win) {
                            win.focus();
                        } else {
