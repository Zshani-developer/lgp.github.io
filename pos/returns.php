...
if(isset($_POST['submit'])) {
    ...
    try {
        ...
        //since it is return form
        //we will store the discount and total net as negative
        $totalDiscount = -1 * $totalDiscount;
        $totalnetAmount = -1 * $totalnetAmount;
//        400
//            100
//        300
//        -100 return
...
//    select sum(total_discount)
        ...
        for($i = 0; $i < $size; $i++) {
            ...
            $currentdiscount = -1 * $currentdiscount;
            $currentnetAmount = -1 * $currentnetAmount;
            ...
            //now we will add back the returned
            //quantity to stock
